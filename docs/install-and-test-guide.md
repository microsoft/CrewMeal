...
| [1. 트랙 A — 내 PC에서 30분 체험](#1-트랙-a--내-pc에서-30분-체험) | 설치 없이 결과 먼저 보기 | 담당 실무자 |
| [2. 트랙 B — Azure 배포](#2-트랙-b--고객사-azure-구독에-배포) | 고품질 AI 분석 켜기 | 클라우드 담당자 |
| [3. 트랙 C — SharePoint · Copilot 연동](#3-트랙-c--sharepoint--copilot-연동) | 실사용 흐름 완성 | M365 관리자 |
| [4. 테스트 시나리오](#4-테스트-시나리오와-합격-기준) | 검증 체크리스트 | 검증 담당자 |
| [5. 환경 변수](#5-환경-변수-총정리) | 설정값 사전 | 운영자 |
| [6. 문제 해결](#6-문제-해결) | 오류별 대처 | 모두 |
| [7. 비용·정리](#7-비용-관리와-정리) | 요금과 삭제 | 관리자 |
| [8. 보안·데이터](#8-보안데이터-취급) | 보안 검토 답변 | 보안 담당자 |
| [9. 도움 요청](#9-도움-요청-시-함께-보내주세요) | 문의 시 보낼 정보 | 모두 |
